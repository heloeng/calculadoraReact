...
<TouchableOpacity style = {styles.buttonCalc} title = "a^b" onPress={ () => { setResultado(Math.pow(calc1.numA, calc1.numB))}}><View><Text style = {styles.buttonFont}>a^b ax</Text></View></TouchableOpacity>
</View>
